...
import com.example.challengepractica.databinding.UpcomingMovieRowsBinding
...
class UpcomingConcatAdapter(private val moviesAdapter: MovieAdapter) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseConcatHolder<*> {
        val itemBinding =
            UpcomingMovieRowsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private inner class ConcatViewHolder(val binding: UpcomingMovieRowsBinding) :
